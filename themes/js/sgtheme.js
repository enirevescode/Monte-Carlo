...
//fonction "read more des cards"
  ...
  let textCache = document.getElementById('textCache');
  let btnText = document.getElementById("moreText");

  moreText.addEventListener("click", () =>{
    if(getComputedStyle(textCache).display != "none"){
      textCache.style.display = "none";
      btnText.innerHTML = "En savoir +"
    } else {
      textCache.style.display = "block";
